 ...
 */
public class ExtensionDSStoreSpider extends ExtensionAdaptor {

    // The name is public so that other extensions can access it
    public static final String NAME = "ExtensionDSStoreSpider";

    // The i18n prefix, by default the package name - defined in one place to make it easier
    // to copy and change this example
    protected static final String PREFIX = "DSStoreSpider";
    ...
    private static final ImageIcon ICON = new ImageIcon(
            ExtensionDSStoreSpider.class.getResource(RESOURCES + "/cake.png"));

    private static final String EXAMPLE_FILE = "Message.txt";

    private ZapMenuItem menuExample;
    private RightClickMsgMenu popupMsgMenuExample;
    private AbstractPanel statusPanel;

    private ExtensionDSStoreSpiderAPI api;

    private static final Logger LOGGER = Logger.getLogger(ExtensionDSStoreSpider.class);

    public ExtensionDSStoreSpider() {
        super(NAME);
    ...
    public void hook(ExtensionHook extensionHook) {
        ...
        this.api = new ExtensionDSStoreSpiderAPI(this);
        ...
        try {
            ...
            if (! f.exists()) {
                ...
                View.getSingleton().showWarningDialog(
                        Constant.messages.getString(ExtensionDSStoreSpider.PREFIX + ".error.nofile", f.getAbsolutePath()));
                return;
            }
