...
public class RightClickMsgMenu extends PopupMenuItemHttpMessageContainer {
    ...
    public RightClickMsgMenu(ExtensionDSStoreSpider ext, String label) {
        super(label);
        /*
    ...
    public void performAction(HttpMessage msg) {
        ...
        View.getSingleton().showMessageDialog(
                Constant.messages
                        .getString(ExtensionDSStoreSpider.PREFIX + ".popup.msg", msg.getRequestHeader().getURI().toString()));
    }
